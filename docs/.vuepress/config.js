...
module.exports = {
  ...
  head: [
    ...
    ['meta', { name: 'twitter:image', content: `${Base_URL}/img/vue-use-date.png` }],
    ['meta', { name: 'twitter:title', content: name }],
    ['meta', { name: 'twitter:description', content: description }],
    ['meta', { name: 'twitter:url', content: Base_URL }],
    ['meta', { property: 'twitter:domain', content: Base_URL }],
    ['meta', { property: 'og:image', content: `${Base_URL}/img/vue-use-date.png` }],
    ['link', { rel: 'manifest', href: '/manifest.json' }],
    ['link', { rel: 'mask-icon', href: `${Base_URL}/img/vue-use-date.png`, color: '#36495e' }],
    ...
    ['link', { rel: 'apple-touch-icon', sizes: '72x72', href: `${Base_URL}/img/vue-use-date.png` }],
    ...
    ['link', { rel: 'icon', type: 'image/png', sizes: '32x32', href: `${Base_URL}/img/vue-use-date.png` }],
